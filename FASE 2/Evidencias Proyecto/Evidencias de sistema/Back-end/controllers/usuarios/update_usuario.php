...
$sql_usuarios = "SELECT users.id_usuario as id_usuario, users.p_nombre as p_nombre, users.s_nombre as s_nombre, users.p_apellido as p_apellido, 
                        users.s_apellido as s_apellido, users.run as run, users.nacionalidad as nacionalidad, users.direccion as direccion, 
